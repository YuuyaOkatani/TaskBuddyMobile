        ...
        <View style={styles.containerThreePerfil}>
          ...
          <View style={{ marginTop: 20 }}>
            <ScrollView style={{ height: 160, width: "auto" }}>
              ...
              <Text style={styles.textStylePerfil}>
                Especialização: {user.expec}
              </Text>
              <Text style={styles.textStylePerfil}>Descrição: {user.Desc}</Text>
            </ScrollView>
          </View>
          <TouchableOpacity
            style={styles.btnChatPerfil}
            onPress={() => chatRoom(user)}
          >
            <View>
              <Text>Conversar</Text>
            </View>
          ...
          <TouchableOpacity
            style={styles.bntvoltarPerfil}
            onPress={() => voltar(user2)}
          >
            <View>
          ...
          <TouchableOpacity
            style={styles.btncontratarPerfil}
            onPress={contrato}
          >
            <View>
              <Text>Criar contrato com o usuario</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
